...
const ReviewSection = () => {
  ...
  return (
    <section className=" py-12 px-4 md:px-8 lg:px-16 w-10/12 mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        reviews.map((review, index) => (
          <div key={index} className="bg-gray-50 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all">
